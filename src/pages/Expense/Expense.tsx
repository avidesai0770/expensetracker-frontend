import { CalendarIcon, Check, CreditCard, FileText, Receipt, Tag, TrendingDown } from "lucide-react";
...
import { UserAddExpenseMutation } from "../../api/queries/query-functions/expense.service";
...
const Expense = () => {
    ...
    const { mutateAsync: addExpense, isPending: loading } = UserAddExpenseMutation()
    ...
    const onSubmit = async (data: AddExpensePayload) => {
    ...
    return <div className="max-w-7xl mx-auto space-y-6">
        <div>
            <div className="flex items-center gap-3 mb-2">
                ...
                <h1 className="text-neutral-900">Add New Expense</h1>
            </div>
            <p className="text-neutral-600">Record your expense and keep track of your spending</p>
        </div>
        <Card className="bg-white/80 backdrop-blur-sm border border-neutral-200/50 shadow-lg">
            <CardHeader className="border-b border-neutral-200/50">
                ...
                <CardDescription>Fill in the information about your expense transaction</CardDescription>
            </CardHeader>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <Card className="bg-white/80 backdrop-blur-sm border border-neutral-200/50 shadow-sm">
                <CardContent className="p-5 space-y-2">
                    ...
                    <p className="text-gray-500 font-medium">₹260</p>
                </CardContent>
            </Card>
            <Card className="bg-white/80 backdrop-blur-sm border border-neutral-200/50 shadow-sm">
                <CardContent className="p-5 space-y-2">
